...
## This directory is for archival purposes only

	This directory holds resources for the first edition of the book. It was published
	on Kindle and is no longer available.

	The new book, updated and much improved, is available from No Starch Press
	at https://nostarch.com/deep-learning-visual-approach in both physical
	and Ebook formats.
